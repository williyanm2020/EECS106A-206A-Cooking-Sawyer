...
from moveit_msgs.msg import OrientationConstraint, Constraints, CollisionObject, PlanningScene, ObjectColor
...
class PathPlanner(object):
    ...
    def add_box_obstacle(self, size, name, pose):
        ...
        self.setColor(name, 0.6, 0, 1, 0.1)  # X, Y, Z (normalized RGB) and A value
