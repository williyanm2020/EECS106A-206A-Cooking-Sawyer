...
def main():
    ...
    joint_names_4 = ['right_j0', 'right_j1', 'right_j2', 'right_j3']
    ...
    print('Enter your starting position joint angle.')
    goal.request.start_state.joint_state.position = [float(input(j + ' start: ')) for j in joint_names_4]
    goal.request.start_state.joint_state.position += [0, 0, 0]
    ...
    print('Enter your ending position joint angle.')
    target_joint_angles = [float(input(j + ' end: ')) for j in joint_names_4]
    target_joint_angles += [0, 0, 0]
