...
def cluster_segment(img, n_clusters, random_state=0):
    ...
    img_shape = img_d.shape[0]*img_d.shape[1]
    img_r = img_d.reshape(img_shape,3)
    ...
    # cluster_img = cv2.resize(img_r, dsize=(img_d.shape[0],img_d.shape[1],img_d.shape[2]))
